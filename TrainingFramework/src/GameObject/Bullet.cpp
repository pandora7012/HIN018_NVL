...
bool Bullet::checkCollision(std::shared_ptr<Slime> obj1)
{
	...
	float obj2_up = this->Get2DPosition().y - 10;
	float obj2_down = this->Get2DPosition().y + 10;
	float obj2_left = this->Get2DPosition().x - 10;
	float obj2_right = this->Get2DPosition().x + 10;
